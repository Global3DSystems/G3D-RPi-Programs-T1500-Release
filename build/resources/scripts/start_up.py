...
G3D-RPi-Programs-T1500-Release-master.zip in the root of flash drive.
...
# Variable constants.
TARGET_FILE_NAME = "G3D-RPi-Programs-T1500-Release-master.zip"
TARGET_FOLDER_NAME = "G3D-RPi-Programs-T1500-Release-master"
    ...
    def check_extract_update(self):
        ...
        for dir_to_scan in os.listdir(USB_MOUNT_DIR):
            ...
            if TARGET_FILE_NAME in os.listdir(dir_to_scan_full_path):
                ...
                # /media/username/usbname/G3D-RPi-Programs-Release-T1500-master.zip
                global ZIP_FILE_DIR
